...
INSERT INTO Customer (email, custName, phoneNo, zipCode, street, city, state, password, rwdPoint)
    VALUES('richard@gmail.com','Richard Castro', '479-679-9091', 72701, '300 N Garland Ave.', 'Fayetteville', 'Arkansas', MD5('dfas452'), 10),
		('costellTyler@yahoo.com', 'Tyler Costello', '501-742-8723', 72002, '300 E Midland Rd.', 'Alexander', 'Arkansas', MD5('fasdf35'), 30),
		('neha@outlook.com', 'Neha Sharma', '417-567-0923', 65619, '500 W Glenstone Ave.', 'Springfield', 'Missouri', MD5('drgt345aw'), 20),
